...
def get_page_wise_chat_history():
    ...
    page_message_keys = message_keys[page_number*message_per_page:(page_number+1)*message_per_page][::-1]
  

    page_messages = get_deserialized_message_for_batches(dynamodb_client, message_table.name, page_message_keys)
    response_data = {
        "topic": topic_topic,
        "goal": topic_goal,
        "page": page_messages,
